...
def transcribe_full(path, name):
    ...
    tmp_wav = f"/tmp/friends_{name}_16k.wav"
    import subprocess
    ...
    out_json = f"/Volumes/WORK 2TB/WORK 2026/SANDBOX/Leilani's Friends/sync_scripts/Master_{name}_Transcript.json"
    with open(out_json, "w") as f:
        json.dump(result, f, indent=4)
    print(f"✅ Saved Master {name} Transcript to {out_json}")

# The Active MICs
mic1 = "/Volumes/WORK 2TB/WORK 2026/SANDBOX/Audio Organized/_Session_Library/2026_0216_0628/MIC1.WAV"
mic2 = "/Volumes/WORK 2TB/WORK 2026/SANDBOX/Audio Organized/_Session_Library/2026_0216_0628/MIC2.WAV"
