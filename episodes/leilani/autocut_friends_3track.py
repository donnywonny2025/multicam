#!/usr/bin/env python3
"""
AI Multicam Auto-Cut (Leilani's Friends) - 3 TRACK VERSION
...
# Ensure Emily's multicam_core is in path for metadata scanning
sys.path.append("/Volumes/WORK 2TB/WORK 2026/SANDBOX/Emily/sync_scripts")
import multicam_core as core

# ============================================================
# CONFIG — VERIFIED OFFSETS (Leilani's Friends)
# ============================================================
BASE = "/Volumes/WORK 2TB/WORK 2026/SANDBOX/Leilani's Friends"
AUDIO_BASE = "/Volumes/WORK 2TB/WORK 2026/SANDBOX/Audio Organized/_Session_Library/2026_0216_0628"
MIC1_PATH = f"{AUDIO_BASE}/MIC1.WAV"
MIC2_PATH = f"{AUDIO_BASE}/MIC2.WAV"

# Calculated math offsets for Leilani's Friends
WIDE_CLIPS = [
    ("Cam 1", "C9119.MP4", -39.8427)
]
HOST_CLIPS = [
    ("Cam 2", "C0001.MP4", -378.0018), 
    ("Cam 2", "C0002.MP4", 1412.7882), 
    ("Cam 2", "C0003.MP4", 2039.4182)
]
GUEST_CLIPS = [
    ("Cam 3", "C0002.MP4", -135.3767), 
    ("Cam 3", "C0003.MP4", 1655.4133), 
    ("Cam 3", "C0004.MP4", 2236.4983), 
    ("Cam 3", "C0005.MP4", 2431.1933)
]
...
def load_or_cache_audio(wav_path, cache_path):
    if not os.path.exists(cache_path):
        print(f"Caching {wav_path} to {cache_path}...")
...
mic1 = load_or_cache_audio(MIC1_PATH, f"{BASE}/sync_scripts/.cache_friends_MIC1_{SR}.raw")
mic2 = load_or_cache_audio(MIC2_PATH, f"{BASE}/sync_scripts/.cache_friends_MIC2_{SR}.raw")
...
audio_clips_mic2 = f"""          <clipitem id="mic2_friends">
            <name>MIC2.WAV</name>
            <duration>{total_frames}</duration>
            <rate><timebase>24</timebase><ntsc>TRUE</ntsc></rate>
            <start>0</start><end>{total_frames}</end>
...
<xmeml version="4">
  <sequence>
    <name>Leilani's Friends AutoCut (3-Track) v1</name>
    <duration>{total_frames}</duration>
    <rate><timebase>24</timebase><ntsc>TRUE</ntsc></rate>
    <media>
      <video>
...
out_path = f"{BASE}/Leilanis_Friends_FINAL_3TRACK_SYNC_v1.xml"
