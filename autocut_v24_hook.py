#!/usr/bin/env python3
"""
Emily v24 — Narrative Hook (better Lilliani)
Built on the Zamiyah Client Edit XML generator architecture.
Smarter Lilliani clips: real questions, not generic reactions.
"""
import json, os
...
EDIT_ANCHORS = [
    ...
    # 6. W: Shared energy — both going at it (NEW)
    ...
    # 12. G: Funny family line
    (857.0, "got", 860.1, "dinner", "Whats For Dinner", "G"),
    #
    # MISSION: Her vision (positive, forward)
    # 13. G: "Bring that magic to 2026"
    (584.4, "and", 588.1, "2026", "Magic 2026", "G"),
    #
    # POWER: Set up the Tootie payoff
    # 14. G: The thesis — leads DIRECTLY into Tootie
    (2525.2, "You", 2529.7, "are", "Know Who You Are", "G"),
    #
    # TOOTIE PAYOFF
    # 15. H: Lilliani sees who Emily is — short, affirming (NEW)
    (2398.1, "You", 2399.0, "creative", "Youre Creative", "H"),
    # 16. H: Build — she wants more
    (2422.6, "I", 2423.5, "this", "Wanna Hear", "H"),
    # 17. G: Tootie performs
    (2474.7, "That", 2477.2, "fabulous", "Fabulous", "G"),
    # 18. H: Lilliani loses it
...
L.append(' <sequence>')
L.append('  <name>Emily v24 Hook</name>')
...
out_comp = f"{BASE}/Emily_v24_Hook.xml"
