#!/usr/bin/env python3
"""
Emily v20 — Narrative Hook
Built on the Zamiyah Client Edit XML generator architecture.
Mini-story in 4 layers: Creative → Funny → Heart → Showstopper.
"""
import json, os
...
# ============================================================
EDIT_ANCHORS = [
    # ── NARRATIVE HOOK — each clip reveals a new layer ──
    #
    # The story: "Meet Emily. She's creative and wild. She's also a
    # real nurse with a huge heart. And wait till you see her characters."
    #
    # LAYER 1: WHO IS SHE? (creative, colorful, fun)
    #
    # 1. W: Open on the vibe — both laughing, we're already having fun
    (134.7, "We've", 136.7, "scenes", "Open Laughing", "W"),
    # 2. G: She tells you who she is — quick, confident
    (320.4, "I", 321.6, "mind", "Creative Mind", "G"),
    # 3. H: Lilliani's eyes light up
    (338.6, "can", 341.2, "character", "Can I See", "H"),
    # 4. G: She's performing live — the sulfuric acid punchline
    (394.6, "That", 396.5, "acid", "Sulfuric Acid", "G"),
    #
    # LAYER 2: WAIT, SHE'S A REAL NURSE? (depth, surprise)
    #
    # 5. G: Quick personality flash — bridges the fun and the real
    (644.7, "I'm", 645.9, "social", "Super Social", "G"),
    # 6. H: Lilliani shifts the conversation — now we go deeper
    (604.0, "So", 607.4, "nurse", "Actual Nurse", "H"),
    # 7. G: And here's her heart
    (694.3, "Knowing", 698.4, "difference", "Touch Care", "G"),
    #
    # LAYER 3: SHE'S HILARIOUS (comedy relief, personality)
    #
    # 8. G: Family stories — funny, real, relatable
    (857.0, "got", 860.1, "dinner", "Whats For Dinner", "G"),
    #
    # LAYER 4: THE SHOWSTOPPER (Tootie payoff)
    #
    # 9. H: Lilliani wants more — builds anticipation
    (2422.6, "I", 2423.5, "this", "Wanna Hear", "H"),
    # 10. G: Tootie arrives — the character everyone remembers
    (2474.7, "That", 2477.2, "fabulous", "Fabulous", "G"),
    # 11. H: Lilliani can't contain herself
    (2467.7, "Oh", 2471.4, "show", "OMG React", "H"),
    # 12. W: The glow — wide shot, both basking in the moment
    (2532.0, "She's", 2533.8, "her", "Love Her", "W"),
    # 13. H: Snap to the close
...
L.append(' <sequence>')
L.append('  <name>Emily v20 Hook</name>')
...
out_comp = f"{BASE}/Emily_v20_Hook.xml"
