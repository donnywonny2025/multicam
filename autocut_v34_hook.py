...
def snap_in(mic_data, fs, w_start, threshold=700):
...
L.append(' <sequence>')
L.append('  <name>Emily v34 Transient Corrected</name>')
...
out_comp = f"{BASE}/Emily_v34_Transient.xml"
