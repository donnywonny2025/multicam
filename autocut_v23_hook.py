#!/usr/bin/env python3
"""
Emily v23 — Narrative Hook (new assembly)
Built on the Zamiyah Client Edit XML generator architecture.
New clips, new flow: MEET → FUN → shared energy → funny story → heart → comedy → mission → TOOTIE.
"""
import json, os
...
EDIT_ANCHORS = [
    ...
    #
    # HEART: Let it breathe for ONE beat
    # 10. G: Her core
    (694.3, "Knowing", 698.4, "difference", "Touch Care", "G"),
    # 11. H: Lilliani validates — short
    ...
    #
    # TOOTIE PAYOFF (don't touch this block)
    # 15. H: Build
    (2422.6, "I", 2423.5, "this", "Wanna Hear", "H"),
    # 16. G: Tootie performs
    (2474.7, "That", 2477.2, "fabulous", "Fabulous", "G"),
    # 17. H: Lilliani loses it
...
L.append(' <sequence>')
L.append('  <name>Emily v23 Hook</name>')
...
out_comp = f"{BASE}/Emily_v23_Hook.xml"
