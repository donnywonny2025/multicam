#!/usr/bin/env python3
"""
Emily v28 — 2-Minute Hook (complete thoughts)
Built on the Zamiyah Client Edit XML generator architecture.
Creative Mind breathes. Tootie full. Clean endings.
"""
import json, os
...
EDIT_ANCHORS = [
    ...
    #
    # FUN: She's creative — COMPLETE thought, not a fragment
    # 3. G: "I have a really creative mind. On my YouTube series, there's different characters."
    #    This gives context AND sets up "Can I see a character?"
    (319.3, "have", 323.8, "characters", "Creative Mind", "G"),
    ...
    #
    # TOOTIE PAYOFF — complete performance, complete reactions
    # 17. H: Lilliani is hyped — "Okay. Okay. I want to hear this."
    (2420.5, "Okay", 2423.7, "this", "Wanna Hear", "H"),
    # 18. G: Tootie's FULL moment — "Let me show you how it's done. That hair, fabulous. Earrings, fabulous!"
    (2473.1, "Let", 2479.7, "fabulous", "Tootie Full", "G"),
    # 19. H: "Oh my gosh. I got her on my show."
    (2467.8, "my", 2471.4, "show", "OMG React", "H"),
    #
    # CLOSE — satisfying, complete
    # 20. W: The glow — wide, both together, genuine
...
L.append(' <sequence>')
L.append('  <name>Emily v28 Hook</name>')
...
out_comp = f"{BASE}/Emily_v28_Hook.xml"
