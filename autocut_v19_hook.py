#!/usr/bin/env python3
"""
Emily v19 — Editorial Hook (fast-paced, more soul)
Built on the Zamiyah Client Edit XML generator architecture.
14 clips: rapid-fire H/W/G with rhythm variation — short pops + longer moments.
"""
import json, os
...
# ============================================================
EDIT_ANCHORS = [
    # ── FAST-PACED EDITORIAL HOOK ──
    # Rhythm: short pop → moment → short pop → moment → BUILD → PAYOFF
    # More Emily personality, more variety, quicker cuts

    # OPEN: Energy + who is this person?
    # 1. W: Starting with a laugh beat (1s)
    (134.7, "We've", 135.9, "having", "We've Been", "W"),
    # 2. G: Emily — "I have a really creative mind" (1.5s)
    (320.0, "I", 321.6, "mind", "Creative Mind", "G"),
    # 3. H: Lilliani pulls — "Can I see a character?" (2s)
    (338.6, "can", 341.2, "character", "Can I See", "H"),

    # FUN: The character bit
    # 4. W: "Keep going keep going!" — shared energy (1.5s)
    (390.6, "keep", 392.7, "going", "Keep Going", "W"),
    # 5. G: Sulfuric acid punchline (2s)
    (394.6, "That", 396.5, "acid", "Sulfuric Acid", "G"),
    # 6. G: "I'm super social" — quick personality pop (1s)
    (644.7, "I'm", 645.9, "social", "Super Social", "G"),

    # HEART: Real talk — slower, let it breathe
    # 7. H: Lilliani goes deep (2.5s)
    (679.4, "What", 681.9, "nurse", "Good Feelings", "H"),
    # 8. G: Emily's heart (3s)
    (694.3, "Knowing", 698.4, "difference", "Touch Care", "G"),

    # FUNNY: Quick personality hit — speed back up
    # 9. G: "got on my nerves, what's for dinner" (3s)
    (857.0, "got", 860.1, "dinner", "Whats For Dinner", "G"),

    # PAYOFF: Tootie — build fast, deliver big
    # 10. H: "I want to hear this" (1.5s)
    (2422.6, "I", 2423.5, "this", "Wanna Hear", "H"),
    # 11. G: Tootie — "That hair, fabulous!" (3s)
    (2474.7, "That", 2477.2, "fabulous", "Fabulous", "G"),
    # 12. H: "Oh my gosh! I got her on my show!" (2.5s)
    (2467.7, "Oh", 2471.4, "show", "OMG React", "H"),

    # CLOSE: Post-Tootie glow
    # 13. W: "She's great. I love her." (2s)
    (2532.0, "She's", 2533.8, "her", "Love Her", "W"),
    # 14. H: "Okay, we're doing it!" (1.5s)
...
L.append(' <sequence>')
L.append('  <name>Emily v19 Hook</name>')
...
out_comp = f"{BASE}/Emily_v19_Hook.xml"
