#!/usr/bin/env python3
"""
Emily v18 — Editorial Hook (with Wide shots)
Built on the Zamiyah Client Edit XML generator architecture.
11 clips: H/W/G back-and-forth with wide breathers showing both speakers.
"""
import json, os
...
# ============================================================
EDIT_ANCHORS = [
    # ── EDITORIAL HOOK with WIDE SHOTS ──
    # H = Host tight, G = Guest tight, W = Wide (both visible)

    # --- BLOCK 1: Characters (curiosity + fun) ---
    # 1. H: Lilliani's curiosity
    (337.8, "Oh", 341.2, "character", "Can I See", "H"),
    # 2. W: Shared excitement — "Absolutely!" (both are grinning)
    (341.7, "Absolutely", 342.3, "Absolutely", "Absolutely", "W"),
    # 3. W: "Keep going keep going!" — shared energy during the bit
    (390.6, "keep", 392.7, "going", "Keep Going", "W"),
    # 4. G: Emily delivers the punchline
    (393.9, "Wait", 396.5, "acid", "Sulfuric Acid", "G"),

    # --- BLOCK 2: The Nurse (depth + heart) ---
    # 5. H: Lilliani asks a real question
    (679.4, "What", 681.9, "nurse", "Good Feelings", "H"),
    # 6. G: Emily's heart
    (694.3, "Knowing", 698.4, "difference", "Touch Care", "G"),

    # --- BLOCK 3: Tootie payoff (showstopper) ---
    # 7. H: Lilliani's buildup — she wants more
    (2420.7, "Okay", 2423.5, "this", "Wanna Hear", "H"),
    # 8. G: Tootie enters — the character performs
    (2453.8, "All", 2458.8, "through", "Tootie Drop", "G"),
    # 9. H: Lilliani loses it
    (2467.7, "Oh", 2471.4, "show", "OMG React", "H"),
    # 10. W: Post-Tootie shared joy — both are glowing
    (2532.0, "She's", 2533.8, "her", "Love Her Wide", "W"),
    # 11. H: The closer — energy out
...
L.append(' <sequence>')
L.append('  <name>Emily v18 Hook</name>')
...
out_comp = f"{BASE}/Emily_v18_Hook.xml"
