#!/usr/bin/env python3
"""
Emily v29 — Soundbox Hook (Draft 1)
...
EDIT_ANCHORS = [
    # ── v29: SOUNDBOX HOOK ──
    # [0:00-0:10] The "Window"
    (0.0, "I", 3.4, "it", "Match Set Love It", "H"),
    (174.3, "Nurse", 181.8, "health", "Nurse Silly", "G"),
    (219.8, "I", 221.7, "Silly", "Saw Nurse Silly", "H"),

    # [0:10-0:30] The "Shift"
    (705.5, "just", 713.2, "family", "Grandma Promise", "G"),
    (1647.5, "And", 1654.8, "detention", "Juvenile Detention", "G"),
    (1684.3, "That's", 1686.0, "well", "Juvenile Reaction", "H"),
    (1324.0, "nobody", 1329.8, "underdog", "Correction Underdog", "G"),
    (1906.4, "And", 1908.5, "okay", "One Person", "H"),

    # [0:30-0:45] The "Peak"
    (151.7, "And", 155.0, "Silly", "Foundation", "H"),
    (2509.0, "The", 2515.6, "imperfections", "Im That Girl", "G"),

    # [0:45-0:50] The "Stinger"
    (143.0, "Her", 148.5, "branded", "Meet Emily Ellis", "H"),
    (155.0, "So", 156.4, "today", "Dive In", "H"),
]
...
L.append(' <sequence>')
L.append('  <name>Emily v29 Hook</name>')
...
out_comp = f"{BASE}/Emily_v29_Hook.xml"
