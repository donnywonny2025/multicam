#!/usr/bin/env python3
"""
Emily v17 — Editorial Hook (8-clip back-and-forth)
Built on the Zamiyah Client Edit XML generator architecture.
8 clips: 4 Lilliani + 4 Emily, bouncing across characters/nursing/Tootie.
"""
import json, os
...
# ============================================================
EDIT_ANCHORS = [
    # ── EDITORIAL HOOK: 4 Lilliani + 4 Emily, 3 acts ──

    # ACT 2 tease: Characters — curiosity + fun
    # 1. H: Lilliani pulls something out of Emily
    (337.8, "Oh", 341.2, "character", "Can I See", "H"),
    # 2. G: Emily delivers — the sulfuric acid bit
    (393.0, "Oh", 396.5, "acid", "Sulfuric Acid", "G"),

    # ACT 3 tease: The Nurse — depth
    # 3. H: Lilliani asks a REAL question
    (679.4, "What", 681.9, "nurse", "Good Feelings", "H"),
    # 4. G: Emily's heart — the core of who she is
    (694.3, "Knowing", 698.4, "difference", "Touch Care", "G"),

    # ACT 5 payoff: Tootie — the show-stopper
    # 5. H: Lilliani wants more
    (2420.7, "Okay", 2423.5, "this", "Wanna Hear", "H"),
    # 6. G: Tootie enters
    (2453.8, "All", 2461.2, "yourself", "Tootie Drop", "G"),
    # 7. H: Lilliani loses it
...
L.append(' <sequence>')
L.append('  <name>Emily v17 Hook</name>')
...
out_comp = f"{BASE}/Emily_v17_Hook.xml"
