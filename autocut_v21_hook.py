#!/usr/bin/env python3
"""
Emily v21 — Narrative Hook (grounded intro)
Built on the Zamiyah Client Edit XML generator architecture.
Lilliani introduces Emily by name first, then layers: Fun → Depth → Payoff.
"""
import json, os
...
# ============================================================
EDIT_ANCHORS = [
    # ── NARRATIVE HOOK (GROUNDED INTRO) ──
    #
    # Viewer knows nothing. First thing they need: WHO am I watching?
    # Then: WHY should I care? Then: SHOW ME something.
    #
    # INTRO: Ground the viewer — who are these people?
    #
    # 1. W: Open on both of them — the vibe, the set, the energy
    (134.7, "We've", 136.7, "scenes", "Open Vibe", "W"),
    # 2. H: Lilliani introduces Emily BY NAME — short + punchy
    (143.0, "Her", 147.0, "exciting", "Meet Emily", "H"),
    # 3. G: Quick identity — board certified nurse practitioner
    (175.0, "Nurse", 177.5, "practitioner", "Nurse Silly Intro", "G"),
    #
    # FUN: She's creative and wild
    #
    # 4. G: "I have a really creative mind"
    ...
    #
    # 7. H: "So you are an actual nurse"
    (604.0, "So", 607.4, "nurse", "Actual Nurse", "H"),
    # 8. G: Her heart — "my touch, my care"
    (694.3, "Knowing", 698.4, "difference", "Touch Care", "G"),
    #
    # COMEDY: She's hilarious
    #
    # 9. G: "What's for dinner" — family humor
    (857.0, "got", 860.1, "dinner", "Whats For Dinner", "G"),
    #
    # PAYOFF: Tootie (keep this whole block — it works)
    #
    # 10. H: "I want to hear this"
    (2422.6, "I", 2423.5, "this", "Wanna Hear", "H"),
    # 11. G: Tootie — "That hair, fabulous!"
    (2474.7, "That", 2477.2, "fabulous", "Fabulous", "G"),
    # 12. H: "Oh my gosh! I got her on my show!"
    (2467.7, "Oh", 2471.4, "show", "OMG React", "H"),
    # 13. W: "She's great. I love her."
    (2532.0, "She's", 2533.8, "her", "Love Her", "W"),
    # 14. H: "Okay, we're doing it!"
...
L.append(' <sequence>')
L.append('  <name>Emily v21 Hook</name>')
...
out_comp = f"{BASE}/Emily_v21_Hook.xml"
